...
function AddProductPage() {
  ...
  const handleAddProduct =async (e)=> {
    ...
    try {
      ...
      const response = await axios.post(ServerConstant.baseUrl+ ServerConstant.admin.product.add, productData, {
        headers: {
      ...
      <div className="bg-white shadow rounded-xl p-6 relative">
        ...
        <form onSubmit={handleAddProduct} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input type="checkbox" name="Electrical" id="electrical" value={"electrical"} onChange={(e)=>handleSelectCategories(e)}/>
            <input type="checkbox" name="Carpenter" id="carpenter" value={"carpenter"} onChange={(e)=> handleSelectCategories(e)} />
            <input type="checkbox" name="Masonry" id="masonry" value={"masonry"} onChange={(e)=> handleSelectCategories(e)}/>
          </div>

          {/* product type */}
          <div className="w-50 border rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-accent">
            <select name="" id="" className="" onChange={(e)=> handleSelectProductType(e)}>
