...
function Sidebar() {
  ...
  return (
    <aside className={`w-[240px] min-h-screen bg-white shadow-md px-4 py-6  sm:hidden absolute right-0 top-0 min-h-full z-50 pt-[90px] ${isSidebarOpen ? "block" : "hidden"} bottom-0 `}>
